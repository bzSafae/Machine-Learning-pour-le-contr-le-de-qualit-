...
# prompt: pour chacun de ces 4 modèle(arbre de décision , random forest , l’ADAboost et réseau de neurone  fait la validation simple et par la suite la validation croisé
